                            ...
                            <div class="form-row">
                                <div class="form-group col-md-6">
                                    <div :class="['col-auto', {'has-error': errors.razao_social}]">
                                        ...
                                        <input type="text" v-model="branche.razao_social" class="form-control mb-2 mr-sm-2" placeholder="Razão Social">
                                    </div>
                                </div>
                                <div class="form-group col-md-6">
                                    <div :class="['col-auto', {'has-error': errors.cnpj}]">
                                        <div v-if="errors.cnpj">{{ errors.cnpj[0] }}</div>
                                        <input type="text" v-model="branche.cnpj" class="form-control mb-2 mr-sm-2" placeholder="CNPJ">
                                    </div>
                                </div>
                            </div>
                            <div class="form-row">
...
export default {
    ...
    methods: {
        onSubmit () {
            ...
            this.$store.dispatch(createOrUpdate, this.branche)
                .then(() => {
