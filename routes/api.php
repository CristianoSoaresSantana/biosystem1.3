...
$this->group([
    ...
    $this->get('materials/{id}/fornecedor', 'MaterialController@fornecedor'); // RELACIONAMENTO N:M, CONSULTA.
    ...
    $this->get('fornecedors/{id}/materials', 'FornecedorController@materials'); // RELACIONAMENTO N:M, CONSULTA.
